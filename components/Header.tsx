...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image src={character1} alt="Inkling" priority />
      </div>
      <div
        className={classNames(
          styles.character2,
      ...
      >
        <Image src={character2} alt="Octoling" priority />
      </div>
      <div
        className={classNames(
          styles.character3,
      ...
      >
        <Image src={character3} alt="Octoling" priority />
      </div>
      <div
        className={classNames(
          styles.character4,
      ...
      >
        <Image src={character4} alt="Inkling" priority />
      </div>
      ...
      >
        <Image src={effect} alt="Paint effect" priority />
      </div>
      ...
      <div className="absolute top-0 right-[5%] my-auto right-0 w-[630px] h-[550px] md:w-[400px] md:h-[400px] md:bottom-auto sm:w-[75%] sm:h-[50%] sm:bottom-0 sm:top-auto sm:left-0 sm:mx-auto">
        ...
        >
          <Image src={logo} alt="Splatoon 3" priority />
        </div>
